...
def load_clip_text_cache(device):
    clip_text_feature_dict = torch.load("/data/xiaoliangqiu/project/InteractDiff/DATA/clip_phrases_feature_cache.pth", map_location=device)
...
if __name__ == "__main__":
    ...
    meta_list = [
        ...
        dict(
            ckpt="/data/xiaoliangqiu/project/InteractDiff/OUTPUT/test/tag27/checkpoint_00500000.pth",
            prompt=text_prompt,
            ...
            save_folder_name=f"generation_hoi{sample_id}"
        ),
    ]
