...
if __name__ == "__main__":
    ...
    parser.add_argument("--yaml_file", type=str,  default="configs/hoi_hico_text.yaml", help="paths to base configs.")
    ...
    parser.add_argument("--total_iters", type=int,  default=600000, help="")
